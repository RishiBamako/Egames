...
public class UserCartActivity extends BaseActivity implements View.OnClickListener, UserCartInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bag_recycler_view = (RecyclerView) findViewById(R.id.bag_recycler_view);
        ...
        no_pro_relative_layout = (RelativeLayout) findViewById(R.id.no_pro_relative_layout);
        relativeLayout1 = (LinearLayout) findViewById(R.id.relativeLayout1);
        //offer_layout = (LinearLayout)findViewById(R.id.offer_layout);
        offer_name = (TextView) findViewById(R.id.offer_name);
        cart_total_price_text_view = (TextView) findViewById(R.id.cart_total_price_text_view);
        liner_layout_discount = (LinearLayout) findViewById(R.id.liner_layout_discount);
        liner_layout_discount.setVisibility(View.GONE);
        discount_price_text_view = (TextView) findViewById(R.id.discount_price_text_view);
        promo_code_edittext = (EditText) findViewById(R.id.promo_code_edittext);
        ...
        redeem_layout = (LinearLayout) findViewById(R.id.redeem_layout);
        redeemed_layout = (LinearLayout) findViewById(R.id.redeemed_layout);
        redeem_point_text = (TextView) findViewById(R.id.redeem_point_text);
        redeemed_point_text = (TextView) findViewById(R.id.redeemed_point_text);
        redeem_button = (Button) findViewById(R.id.redeem_button);
        findViewById(R.id.redeem_button).setOnClickListener(this);
        redeem_remove_button = (Button) findViewById(R.id.redeem_remove_button);
        findViewById(R.id.redeem_remove_button).setOnClickListener(this);
        loyalty_price_text_view = (TextView) findViewById(R.id.loyalty_price_text_view);
        liner_layout_loyalty_point = (LinearLayout) findViewById(R.id.liner_layout_loyalty_point);
        liner_layout_loyalty_point_add = (LinearLayout) findViewById(R.id.liner_layout_loyalty_point_add);
        loyalty_point_text_view = (TextView) findViewById(R.id.loyalty_point_text_view);
    ...
    private void suggestAboutDeliveryOption() {
        final Dialog dialog = new Dialog(UserCartActivity.this);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        dialog.setCancelable(false);
        ...
        shareCodeOnWhatsApp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                Utils.saveEventStatus("whatsapp", "DELIVERY_OPTION", UserCartActivity.this);
            }
        });
        pleaseDeliverIt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                Utils.saveEventStatus("deliver", "DELIVERY_OPTION", UserCartActivity.this);
            }
        });
