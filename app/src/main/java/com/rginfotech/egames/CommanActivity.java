...
import com.rginfotech.egames.adapter.FAQDetailAdapter;
import com.rginfotech.egames.api.API;
import com.rginfotech.egames.localization.BaseActivity;
import com.rginfotech.egames.model.FAQDetailModel;
...
public class CommanActivity extends BaseActivity implements View.OnClickListener {
  ...
  private int item_count_number=0;
  ...
  private AutoCompleteTextView searchView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title_text_view.setText(titleName);

        if (CommanMethod.isInternetConnected(CommanActivity.this)){
            getDetails();
            //searchProduct();
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.cart_image:
                Intent intent = new Intent(CommanActivity.this,UserCartActivity.class);
                startActivity(intent);
                break;
            case R.id.filter_image:
                Intent intent1 = new Intent(CommanActivity.this,FilterActivity.class);
    ...
    private void getDetails(){
        ...
        StringRequest mStringRequest = new StringRequest(Request.Method.POST, API.BASE_URL+"faq_detail", new com.android.volley.Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    gifImageView.setVisibility(View.GONE);
                    faqDetailModelArrayList = new ArrayList<>();
                    ...
                    if(status.equals("success")){
                        ...
                        for(int i=0;i<jsonArray.length();i++){
                            ...
                            FAQDetailModel faqDetailModel = new FAQDetailModel();
                            faqDetailModel.setId(jsonObject.getString("id"));
                            faqDetailModel.setName(jsonObject.getString("name"));
                            faqDetailModel.setTitle(item_count_number+". "+jsonObject.getString("title"));
                            faqDetailModel.setSubtitle(jsonObject.getString("subtitle"));
                            faqDetailModel.setDescription(jsonObject.getString("description"));
                            faqDetailModel.setTitle_ar(jsonObject.getString("title_ar"));
                            faqDetailModel.setDescription_ar(jsonObject.getString("description_ar"));
                            faqDetailModel.setSeourl(jsonObject.getString("seourl"));
                            faqDetailModel.setParent(jsonObject.getString("parent"));
                            faqDetailModel.setMeta_tag(jsonObject.getString("meta_tag"));
                            faqDetailModel.setMeta_description(jsonObject.getString("meta_description"));
                            faqDetailModel.setStatus(jsonObject.getString("status"));
                            faqDetailModel.setMeta_title(jsonObject.getString("meta_title"));
                            faqDetailModel.setCreated_at(jsonObject.getString("created_at"));
                            faqDetailModel.setUpdated_at(jsonObject.getString("updated_at"));
                            faqDetailModel.setImage(jsonObject.getString("image"));
                            faqDetailModel.setMulti_image(jsonObject.getString("multi_image"));
                            faqDetailModel.setPost_type(jsonObject.getString("post_type"));
                            faqDetailModel.setCategory(jsonObject.getString("category"));
                            faqDetailModelArrayList.add(faqDetailModel);
                        }
                ...
                faqDetailAdapter = new FAQDetailAdapter(faqDetailModelArrayList,CommanActivity.this);
                listView.setAdapter(faqDetailAdapter);
    ...
    private void sortDialog(){
        ...
        searchView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                /*Intent intent = new Intent(CommanActivity.this,SearchResultsActivity.class);
                intent.putExtra("array_of_product_lists",array_of_product_lists);
                startActivity(intent);*/
                Intent intent = new Intent(CommanActivity.this,ProductDetailsActivity.class);
        ...
        search_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(getSearchText.equals("") || getSearchText.length()==0){
                    ...
                    Utils.hideKeyBoard(CommanActivity.this,searchView);
                }
            }
        });
        dialog.show();
    ...
    private void searchProduct(String search_text){
        ...
        StringRequest mStringRequest = new StringRequest(Request.Method.POST, API.BASE_URL+"productlist_of_brand", new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                searchadapter= new ArrayAdapter<ProductSearchModel>(CommanActivity.this,android.R.layout.simple_list_item_1, productLists);
