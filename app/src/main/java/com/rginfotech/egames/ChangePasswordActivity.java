...
public class ChangePasswordActivity extends BaseActivity implements View.OnClickListener {
    ...
    private EditText old_pass_edittext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        old_pass_edittext = (EditText)findViewById(R.id.old_pass_edittext);
        backLinLayoutId = findViewById(R.id.backLinLayoutId);
        backLinLayoutId.setOnClickListener(this);
        new_pass_edittext = (EditText)findViewById(R.id.new_pass_edittext);
        confirm_pass_edittext = (EditText)findViewById(R.id.confirm_pass_edittext);
        ...
        if (CommanMethod.isInternetConnected(ChangePasswordActivity.this)){
            //searchProduct();
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.cart_image:
                Intent intent = new Intent(ChangePasswordActivity.this, UserCartActivity.class);
            ...
            case R.id.filter_image:
                Intent intent1 = new Intent(ChangePasswordActivity.this, FilterActivity.class);
    ...
    private void validation(){
        getOldPassword = old_pass_edittext.getText().toString();
        getNewPassword = new_pass_edittext.getText().toString();
        getConfirmPassword = confirm_pass_edittext.getText().toString();
        if(getOldPassword.equals("") || getOldPassword.length()==0){
            CommanMethod.getCustomOkAlert(this,this.getString(R.string.toast_message_old_pass));
            //Toast.makeText(this,this.getString(R.string.toast_message_old_pass),Toast.LENGTH_SHORT).show();
        }else if(getNewPassword.equals("") || getNewPassword.length()==0){
            CommanMethod.getCustomOkAlert(this,this.getString(R.string.toast_message_new_pass));
            //Toast.makeText(this,this.getString(R.string.toast_message_new_pass),Toast.LENGTH_SHORT).show();
        }else if(getConfirmPassword.equals("") || getConfirmPassword.length()==0){
            CommanMethod.getCustomOkAlert(this,this.getString(R.string.toast_message_con_pass));
            //Toast.makeText(this,this.getString(R.string.toast_message_con_pass),Toast.LENGTH_SHORT).show();
        }else if(!getNewPassword.equals(getConfirmPassword)){
            CommanMethod.getCustomOkAlert(this,this.getString(R.string.toast_message_not_match));
            //Toast.makeText(this,this.getString(R.string.toast_message_not_match),Toast.LENGTH_SHORT).show();
        }else{
            if (CommanMethod.isInternetConnected(ChangePasswordActivity.this)){
                changePassword();
            }
    ...
    private void changePassword(){
        ...
        StringRequest mStringRequest = new StringRequest(Request.Method.POST, API.BASE_URL+"my_profile_password_update", new com.android.volley.Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    ...
                    if(status.equals("success")){
                        String message = CommanMethod.getMessage(ChangePasswordActivity.this, object);
            ...
            protected Map<String, String> getParams()
            {
                ...
                params.put("old_password", getOldPassword);
                params.put("password", getNewPassword);
                return params;
            }
        };
    ...
    public void parseVolleyError(VolleyError error) {
        try {
            ...
            String message = CommanMethod.getMessage(ChangePasswordActivity.this, data);
            CommanMethod.getCustomOkAlert(ChangePasswordActivity.this, message);
    ...
    private void sortDialog(){
        ...
        searchView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                /*Intent intent = new Intent(ChangePasswordActivity.this,SearchResultsActivity.class);
                intent.putExtra("array_of_product_lists",array_of_product_lists);
                startActivity(intent);*/
                Intent intent = new Intent(ChangePasswordActivity.this,ProductDetailsActivity.class);
                ...
                Utils.hideKeyBoard(ChangePasswordActivity.this,searchView);
            }
    ...
    private void searchProduct(String search_text){
        ...
        StringRequest mStringRequest = new StringRequest(Request.Method.POST, API.BASE_URL+"productlist_of_brand", new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                searchadapter= new ArrayAdapter<ProductSearchModel>(ChangePasswordActivity.this,android.R.layout.simple_list_item_1, productLists);
