...
public class AboutUsActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (CommanMethod.isInternetConnected(AboutUsActivity.this)){
            getAboutUs();
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.cart_image:
                Intent intent = new Intent(AboutUsActivity.this,UserCartActivity.class);
            ...
            case R.id.filter_image:
                Intent intent1 = new Intent(AboutUsActivity.this,FilterActivity.class);
                ...
                try {
                    ...
                    if(status.equals("success")){
                        ...
                        if(getResources().getConfiguration().getLayoutDirection() == View.LAYOUT_DIRECTION_LTR){
                            ...
                            about_us_textview.setText(spanned);
                        }else{
    ...
    private void sortDialog(){
        ...
        searchView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                /*Intent intent = new Intent(AboutUsActivity.this,SearchResultsActivity.class);
                intent.putExtra("array_of_product_lists",array_of_product_lists);
                startActivity(intent);*/

                Intent intent = new Intent(AboutUsActivity.this,ProductDetailsActivity.class);
                ...
                Utils.hideKeyBoard(AboutUsActivity.this,searchView);
            }
    ...
    private void searchProduct(String search_text){
        ...
        StringRequest mStringRequest = new StringRequest(Request.Method.POST, API.BASE_URL+"productlist_of_brand", new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                searchadapter= new ArrayAdapter<ProductSearchModel>(AboutUsActivity.this,android.R.layout.simple_list_item_1, productLists);
